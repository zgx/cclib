...
class GateApi:
    ...
    def get_candles(self, symbol, start_time: datetime=None, end_time: datetime=None, interval='1m'):
        """
        获取历史K线
        :param symbol:
        :param start_time:
        ...
        :return:
        """
        uri = "/api/v4/spot/candlesticks"
        params = {"currency_pair": symbol, "interval": interval}  #, 'start_time': start_time.timestamp(), 'end_time': end_time.timestamp()}
        if start_time:
